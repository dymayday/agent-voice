...
final class SetupWindowViewSourceTests: XCTestCase {
    ...
    func testSummaryVoiceControlsAndDebouncedPreviewArePreserved() throws {
        ...
        XCTAssertTrue(source.contains("IGNORED PHRASES"))
        XCTAssertTrue(source.contains("model.draftIgnoreTextPhrases"))
        XCTAssertTrue(source.contains("Done — updated tests"))
